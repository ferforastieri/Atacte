<template>
  <div class="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
      ...
      <!-- Security Info -->
      <BaseCard variant="outlined" class="bg-green-50 border-green-200">
        <div class="text-center">
          <ShieldCheckIcon class="mx-auto h-8 w-8 text-green-600" />
          <h3 class="mt-2 text-sm font-medium text-green-800">Segurança</h3>
